...
fn process_message(
    ...
    // ============================================
    // CRITICAL FIX: Loop through ALL asset_ids in the message
    // Polymarket sends BOTH YES and NO tokens in price_changes array
    // ============================================
    ...
    while let Some(asset_idx) = asset_pattern.find(&bytes[search_start..]) {
                                ...
                                if size_start < len {
                                    if let Some(size_end) = memchr(b'"', &bytes[size_start..]) {
                                        ...
                                        if size_end_idx <= len {
                                            ...
                                            // Edge detection with token pair mapping
        ...
        // Move past this token to find the next one in the array
        search_start = token_start + 66;
    }
    
    // DEBUG: Log how many tokens we parsed from this message
    if tokens_parsed > 0 {
    ...
    // 5-second stats + diagnostic dump
    if last_stat_time.elapsed() >= Duration::from_secs(5) {
        ...
        println!("🎯 Total fully populated pairs: {}/12", populated_pairs);
        println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
