...
//!
//! CRITICAL FIX: Handle WebSocket messages correctly without breaking connection
    ...
    loop {
        ...
        let msg = match socket.read() {
            ...
            Err(e) => {
                ...
                // DON'T continue - the socket is closed
        ...
        // Handle ALL message types, not just Text
        match msg {
            Message::Text(text) => {
            ...
            Message::Binary(data) => {
                // Polymarket might send binary - try as UTF-8
            ...
            Message::Ping(data) => {
                // CRITICAL: Respond to ping with pong
            ...
            Message::Close(_) => {
                eprintln!("[HFT] Received Close frame - reconnecting...");
...
fn process_text_message(
    ...
    // ============================================
    // SERDE_JSON PARSING (STABLE - WORKS)
    ...
    if let Ok(value) = serde_json::from_str::<serde_json::Value>(text) {
        ...
        // Try price_changes format (incremental updates)
