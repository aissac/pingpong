#!/usr/bin/env python3
"""Write the fixed hft_hot_path.rs with correct byte markers"""

code = r'''//! HFT Hot Path - FIXED with raw byte strings
...
pub fn run_sync_hot_path(
    ...
    println!("⚡ Rate-Limited Hot Path Started (FIXED PARSER)");
...
fn parse_and_update_orderbook(
    ...
    // Raw byte markers - matches JSON exactly: "asset_id":"
...
print('✅ Wrote fixed hft_hot_path.rs')
print('   Byte markers use raw strings: b"\"asset_id\":\""')
