...
use crate::signing::{Order, sign_polymarket_order, create_order, generate_salt};
...
pub fn record_hedge_pair(
    ...
    // Track pending hedge
    state.pending_hedges.insert(maker_order_id, (taker_token_id, taker_size));

    println!(
        "📝 Hedge recorded: Maker={} Taker={} Size={}",
        maker_order_id, taker_token_id, taker_size
    );
}
