#!/usr/bin/env python3
"""Rewrite market_rollover.rs to use same logic as crypto_markets"""
            ...
            for (period_ts, timeframe) in &periods {
                ...
                match fetch_market_tokens(&client, &slug).await {
                    ...
                    None => {
                        ...
                        // Don't add to active_this_cycle so it gets removed if tracked
                    }
                }
            }
        }
        
        // Find and remove expired markets
...
print('✅ Rewrote market_rollover.rs with correct logic')
